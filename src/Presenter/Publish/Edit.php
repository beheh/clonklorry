    ...
    public function post($id)
    {
        ...
        if (isset($_POST['addon-form'])) {
            if ($addon->isSubmittedForApproval() || $addon->isApproved()) {
                ...
                try {
                    ...
                    $errors[] = sprintf(gettext('English title is %s.'),
                        $ex->getMessage());
                ...
                try {
                    ...
                    $errors[] = sprintf(gettext('German title is %s.'),
                        $ex->getMessage());
                    $this->context['title_de'] = $title_de;
                }

                $namespace = trim(strtolower(filter_input(INPUT_POST,
                            'namespace')));
                try {
                    ...
                    $errors[] = sprintf(gettext('Namespace is %s.'),
                        $ex->getMessage());
                }
                ...
                try {
                    ...
                    $errors[] = sprintf(gettext('Game is %s.'),
                        $ex->getMessage());
                }
                ...
                try {
                    ...
                    $errors[] = sprintf(gettext('Abbreviation is %s.'),
                        $ex->getMessage());
        ...
        if (isset($_POST['presentation-form'])) {
            ...
            try {
                ...
                $errors[] = sprintf(gettext('Introduction is %s.'),
                    $ex->getMessage());
            }
            ...
            try {
                ...
                $errors[] = sprintf(gettext('Description is %s.'),
                    $ex->getMessage());
            }
            ...
            try {
                ...
                $errors[] = sprintf(gettext('Bugtracker is %s.'),
                    $ex->getMessage());
            }
            ...
            if (empty($errors)) {
                if ($addon->modified()) {
                    $addon->save();
                    $this->success('presentation',
                        gettext('Presentation saved.'));
                }
            } else {
        ...
        if (isset($_POST['releases-form'])) {
            ...
            if ($this->persistence->build('Release')->byVersion($version,
                    $addon->getId()) !== null) {
